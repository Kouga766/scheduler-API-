...
export default Vue.extend({
  ...
  methods: {
    ...
    initialize: async function(){ // 連鎖させたい処理はasync function!
      ...
      let url = `/tasks/get_tasks_count_for_user/?id=hironov120`;
      let result = await accessApi.getApi(url); // awaitを書いて、待たせる？
      ...
      url = `/tasks/get_tasks_for_user/?id=hironov120&sort_state=${this.sortState}&display_state=${Vue.prototype.$displayState}`;
